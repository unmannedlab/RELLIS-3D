        ...
        for i, fname in enumerate(fnames):
            ...
            if sensor_name:
                ...
                try:
                    ...
                    if id_color_map:
                        color_file = collection_path / Path(sid) / Path(str(sensor_name)+'label_color/'+fname_stem+ext_out)
...
if __name__ == '__main__':
    """Merge jsonlines formatted files, given sequences of filenames. Filename naming convention is assumed to be
